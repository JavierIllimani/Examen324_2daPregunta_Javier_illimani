...
<body>   
        ...
        <?php
            ...
            echo "<tr>";
            echo "<td>Lugar de Residencia</td>";            //Se da un nombre a la primera fila
            for($i = 0; $i < $registrosTotales; $i++){
                echo "<td>" .$lugarResArr[$i]. "</td>";         // se llena cada espacio de la primera fila
            }
            echo "</tr>";
        
            echo "<tr>";
            echo "<td>Aprobados por departamento</td>";     //Se da un nombre a la segunda fila
            for($i = 0; $i < $registrosTotales; $i++){
                echo "<td>" .$AprobadosArr[$i]. "</td>";    // se llena cada espacio de la segunda fila
            }
            echo "</tr>";
